  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <p className="text-base-content/60">Bắt đầu để tạo tài khoản miễn phí</p>
            </div>
          </div>
      ...
      <AuthImagePattern
        ...
        subtitle="Kết nối bạn bè, chia sẽ khoảnh khắc và giữ liên lạc với những người thân yêu của bạn."
      />
    </div>
  );
};
